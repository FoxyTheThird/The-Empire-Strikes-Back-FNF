	...
	public function new(name:String)
	{
		...
		netStream.client = {
			onMetaData: function()
			{
                ...
                // FlxG.width & FlxG.height respectively
        ...
        // FlxG.stage.stageHeight & FlxG.stage.stageHeight * (16/9) respectively
		vlcBitmap.set_height(500);
		vlcBitmap.set_width(500 * (16/9));

        vlcBitmap.x = FlxG.width / 2;
        vlcBitmap.y = FlxG.height / 2;
